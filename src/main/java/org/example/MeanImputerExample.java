...
import FeatureGeneration.NumericalValue.MeanImputer.MeanImputer;
import FeatureGeneration.NumericalValue.MeanImputer.MeanImputerModel;
...
public class MeanImputerExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建并配置 MeanImputer 实例
        MeanImputer meanImputer = new MeanImputer()
                .setInputCol("value")
                .setOutputCol("imputed_value");

        // Fit the estimator and get the model
        MeanImputerModel model = meanImputer.fit(inputTable);
        // Apply model
